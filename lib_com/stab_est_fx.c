...
)
{
    ...
    *mem_etot = etot;
    ...
    test();
    test();
    IF ((LT_16(dev, thresh[3]))&&(GE_16(*last_music_flag,3)))
    {
        music_flag2 = 4;
        move16();
        *nb_thr_3 += 1;
     ...
     *--------------------------------------------------------------------*/
    ELSE IF ((LT_16(dev, thresh[2]))&&(GE_16(*last_music_flag,2)))
    {
        music_flag2 = 3;
        move16();
        *nb_thr_3 += 1;
     ...
     *--------------------------------------------------------------------*/
    ELSE IF ((LT_16(dev, thresh[1]))&&(GE_16(*last_music_flag,1)))
    {
        music_flag2 = 2;
        move16();
    }
    ...
    ELSE IF (GT_16(*nb_thr_1,NB_TH1_MIN))
    {

...
extern const Word16 acos_slope[128];
extern const Word16 cos_table_129[129];
...
extern const Word16 CB_lsf_fx[];
extern const Word16 CB_p_lsf_fx[];
...
extern const Word16 FixBranch_tbl[4][4][N_STAGE_VQ - 4];
...
extern const Word16 filter_LP24_90H_13b_fx[];
extern const Word16 filter_LP24_90H_fx[];

extern const Word16 inter4_1_fx[];

extern const Word16 Low_H_phasedisp[L_SUBFR];
extern const Word16 Mid_H_phasedisp[L_SUBFR];
...
/* Band structure */
extern const Word16 band_len_HQ[];
extern const Word16 band_start_HQ[];
extern const Word16 band_end_HQ[];
...
extern const Word16 bits_lagIndices_modeNormal_fx[NB_SWB_SUBBANDS];
...
extern const Word16 lim_neg_inv_tbl_fx[11];
...
extern const Word16 E_ROM_qua_gain5b_const[NB_QUA_GAIN5B * 2];
extern const Word16 E_ROM_qua_gain6b_const[NB_QUA_GAIN6B * 2] ;
extern const Word16 E_ROM_qua_gain7b_const[NB_QUA_GAIN7B * 2] ;
...
/*fd_cng_commom.h*/
extern const Word16 d_array[18];
extern const Word16 m_array[18];
#define msQeqInvAv_thres_EXP      (-4)
extern const Word16 msQeqInvAv_thresh[3];
extern const Word16 msNoiseSlopeMax[4];
...
extern const Word16 sidparts_encoder_noise_est[24];
...
extern const Word16 maxN_37bits;
extern const Word16 maxC_37bits;
extern const Word16 stages_37bits;
extern const Word16 levels_37bits[6];
extern const Word16 bits_37bits[6];
...
extern const Coding * codesTnsCoeffSWBTCX20[];
extern const Coding * codesTnsCoeffSWBTCX10[];
extern const Coding * codesTnsCoeffWBTCX20[];
...
extern const Word16 cf_off_se02_tab[9][IGF_CTX_COUNT];
...
extern const Word16 sqrt_table_pitch_search[256+1];
...
extern const Word16 low_len[10];
extern const Word32 low_mask[10];
extern const Word16 indx_fact[10];
extern const Word16 index_len[3];
extern const UWord32 index_mask_ACELP[3];

extern const Word16 inv_jp2[];

...
)
{
    ...
    IF (EQ_16(n, 16))
    {
        cdftForw_fx(2*n,z,Ip_fft16_fx,w_fft512_fx);
    }
    ELSE IF (EQ_16(n, 32))
    {
        cdftForw_fx(2*n,z,Ip_fft32_fx,w_fft512_fx);
    }
    ELSE IF (EQ_16(n, 64))
    {
        cdftForw_fx(2*n,z,Ip_fft64_fx,w_fft512_fx);
    }
    ELSE IF (EQ_16(n, 128))
    {
        cdftForw_fx(2*n,z,Ip_fft128_fx,w_fft512_fx);
    }
    ELSE IF (EQ_16(n, 256))
    {
        cdftForw_fx(2*n,z,Ip_fft256_fx,w_fft512_fx);
    }
    ELSE IF (EQ_16(n, 512))
    {

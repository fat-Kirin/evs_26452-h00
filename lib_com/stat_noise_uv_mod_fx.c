...
)
{
    ...
    test();
    test();
    IF (EQ_16(coder_type,INACTIVE)&&(EQ_32(bitrate,ACELP_9k60)||(LT_32(bitrate,ACELP_9k60)&&GT_16(bwidth_fx,NB))))
    {
    ...
    IF ( EQ_16(coder_type,INACTIVE)&&(EQ_32(bitrate,ACELP_9k60)||(LT_32(bitrate,ACELP_9k60)&&GT_16(bwidth_fx,NB))))
    {
        ...
        *Q_stat_noise_ge = GE_SHIFT;
        ...
        IF (LT_16(min_alpha, TILT_COMP_LIM_FX))
        {

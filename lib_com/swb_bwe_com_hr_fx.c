...
)
{
    ...
    IF( GT_16(tilt_wb_fx, 10240))
    {
        FOR( i=0; i<Nsv; i++ )
        {
            ...
            test();
            if( EQ_16(max_bwe_fx, min_bwe_fx)&&GT_16(min_bwe_fx,shl(1,Q_audio)))
            {
...
)
{
    ...
    ELSE
    {
        ...
        IF( nq[i] == 0 )
        {
            ...
            IF( GT_16(pos_end, shl(pos_start, 1)))
            {

...
{
    /* Left part */
    IF ( EQ_16(left_mode,MIN_OVERLAP))
    {
        test();
        IF ( EQ_16(L,256)||EQ_16(L,512))
        {
    ...
    ELSE IF( EQ_16(left_mode,HALF_OVERLAP))
    {
        test();
        IF ( EQ_16(L,256)||EQ_16(L,512))
        {
    ...
    ELSE IF  (EQ_16(left_mode, ALDO_WINDOW))   /* ALDO */
    {
        test();
        IF  ( EQ_16(L,256)||EQ_16(L,512))
        {
    ...
    /* Right part */
    test();
    IF ( EQ_16(right_mode,MIN_OVERLAP)||EQ_16(right_mode,TRANSITION_OVERLAP))
    {
        test();
        IF  ( EQ_16(L,256)||EQ_16(L,512))
        {
    ...
    ELSE IF  (EQ_16(right_mode, HALF_OVERLAP))
    {
        test();
        IF  ( EQ_16(L,256)||EQ_16(L,512))
        {
    ...
    ELSE IF  (EQ_16(right_mode,ALDO_WINDOW))
    {
        test();
        IF  ( EQ_16(L,256)||EQ_16(L,512))
        {

                    ...
                    )
{
    ...
    FOR (tile_idx = 0; tile_idx < nTiles; tile_idx++)
    {
        ...
        IF (EQ_16(IGF_WHITENING_STRONG, hPrivateData->currWhiteningLevel[tile_idx]))
        {
            Word32 abs_sum;
              abs_sum =  0;
			  move32();
                    ...
                    )
{
    ...
    move16();
    hPrivateData->totalNoiseNrg             = 0; move32();
    hPrivateData->totalNoiseNrg_off         = 0; move32();

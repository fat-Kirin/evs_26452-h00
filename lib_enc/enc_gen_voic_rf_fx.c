...
)
{
    ...
    *------------------------------------------------------------------------*/
    ...
    Es_pred_rf = 0;
    IF( acelp_cfg_rf->nrg_mode > 0 && NE_16(rf_frame_type,RF_NELP))
    {
    ...
    *------------------------------------------------------------------------*/
    ...
    FOR (i_subfr=0; i_subfr<L_frame; i_subfr+=L_SUBFR)
    {
        ...
        IF( NE_16(rf_frame_type,RF_NELP))
        {
        ...
        ELSE
        {
            ...
            *-----------------------------------------------------------------*/
            ...
            IF ( acelp_cfg_rf->ltp_bits!=0 )
            {
                ...
                if( acelp_cfg_rf->gains_mode[i_subfr/L_SUBFR] > 0 )
                {
                    rf_coder_type = acelp_cfg_rf->gains_mode[i_subfr/L_SUBFR];
                    move16();
                }
            ...
            *----------------------------------------------------------------------*/
            ...
            IF( i_subfr < sub(L_frame,L_SUBFR) )
            {
                ...
                *----------------------------------------------------------*/
                ...
                gp_clip_test_gain_pit_fx( st->core_brate_fx, gain_pit, st->rf_clip_var );

        ...
        case 7:
            {
                ...
                move16();
                if ( EQ_16(clip_gain,1))size=sub(size,30);
                BREAK;
            }
        case 6:
            {
                ...
                move16();
                if ( EQ_16(clip_gain,1))size=sub(size,14);
                BREAK;
            }
        case 5:
            {
                ...
                move16();
                if ( EQ_16(clip_gain,1))size=sub(size,6);
                BREAK;
            }
        default:
            {
    ...
    *gain_inov = extract_h(L_shl(L_inov, sub(exp_inov, 3))); /* gain_inov in Q12 */
        ...
        case 8:
            {
                ...
                move16();
                if ( EQ_16(clip_gain,1))size=sub(size,60);
                move16();
                BREAK;
            }
        case 7:
            {
                ...
                move16();
                if ( EQ_16(clip_gain,1))size=sub(size,27);
                move16();
                BREAK;
            }
        case 6:
            {
                ...
                move16();
                if ( EQ_16(clip_gain,1))size=sub(size,10);
                move16();
                BREAK;
            }
        }
    ...
    ELSE IF (EQ_16(i_subfr,L_SUBFR))
    {
        ...
        case 6:
        {
            ...
            move16();
            if ( EQ_16(clip_gain,1))size=sub(size,12);
            move16();
            BREAK;
        }
        }

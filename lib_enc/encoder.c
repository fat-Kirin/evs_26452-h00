...
int main( int argc, char** argv )
{
    ...
    while( (n_samples = (short)fread(data, sizeof(short), input_frame, f_input)) > 0 )
    {
        ...
        IF( Opt_RF_ON_loc && rf_fec_offset_loc != 0 && EQ_32( st_fx->total_brate_fx, ACELP_13k20 )&&NE_32(st_fx->input_Fs_fx,8000)&&st_fx->max_bwidth_fx!=NB)
        {
        ...
        IF ( (EQ_32( st_fx->input_Fs_fx, 8000 )||(st_fx->max_bwidth_fx==NB))&&GT_32(st_fx->total_brate_fx,ACELP_24k40))
        {

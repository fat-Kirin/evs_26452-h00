                ...
                )
{
    ...
    zerop1 = 0; move32();
    t_sp_center = 0; move32();
    frame_power = 0; move32();
    ...
    t_sp_center_nb = t_sp_center; move32();
    frame_power_nb = frame_power; move32();
    ...
    t_sp_center = 0; move32();
    frame_power = 0; move32();
    IF(EQ_32(bandwith,CLDFBVAD_WB_ID))
    {
        FOR (i=10; i<20; i++)
        {
            sb_power_shr[i] = L_shr(sb_power[i],5);
    ...
    ELSE IF(EQ_32(bandwith, CLDFBVAD_SWB_ID))
    {
        FOR (i=10; i<24; i++)
        {
            sb_power_shr[i] = L_shr(sb_power[i],5);
    ...
    ELSE
    {
        t_sp_center = t_sp_center_nb; move32();
        frame_power = frame_power_nb; move32();

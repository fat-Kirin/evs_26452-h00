...
)
{
    ...
    if (EQ_16(st_fx->last_nelp_mode_fx,1)&&NE_16(st_fx->bwidth_fx,st_fx->last_bwidth_fx))
    {
    ...
    ELSE IF (EQ_16(st_fx->bwidth_fx,WB)||EQ_16(st_fx->bwidth_fx,SWB))
    {
        IF (st_fx->last_nelp_mode_fx != 1)
        {
            BP1_ORDER =4;
    ...
    {
        test();
        IF (st_fx->bwidth_fx == WB || EQ_16(st_fx->bwidth_fx,SWB))
        {
            set16_fx(st_fx->shape1_filt_mem_fx, 0, 10);
            set16_fx(st_fx->shape2_filt_mem_fx, 0, 10);
            set16_fx(st_fx->shape3_filt_mem_fx, 0, 10);
            set16_fx(st_fx->txlpf1_filt1_mem_fx, 0, 10);
            set16_fx(st_fx->txlpf1_filt2_mem_fx, 0, 10);
            set16_fx(st_fx->txhpf1_filt1_mem_fx, 0, 10);
            set16_fx(st_fx->txhpf1_filt2_mem_fx, 0, 10);
            st_fx->qprevIn_fx = 0;
            move16();
            st_fx->qprevGain_fx = 0;
            move16();
    ...
    IF ( EQ_16(st_fx->bwidth_fx,WB)||EQ_16(st_fx->bwidth_fx,SWB))
    {
        ...
        qf = qIn;
        move16();
        Scale_sig(st_fx->txlpf1_filt1_mem_fx, 10, (qf-st_fx->qprevIn_fx));
        ...
        qf = qIn;
        move16();
        Scale_sig(st_fx->txhpf1_filt1_mem_fx, 10, qf-st_fx->qprevIn_fx);
    ...
    IF (st_fx->bwidth_fx == WB|| EQ_16(st_fx->bwidth_fx,SWB))
    {
        Scale_sig(st_fx->shape1_filt_mem_fx, 10, (qGain-st_fx->qprevGain_fx));
        ...
        qf1 = qGain;
        move16();
        Scale_sig(st_fx->txlpf1_filt2_mem_fx, 10, (qf1-st_fx->qprevGain_fx));
        ...
        qf = qGain;
        move16();
        Scale_sig(st_fx->txhpf1_filt2_mem_fx, 10, (qf-st_fx->qprevGain_fx));
        ...
        IF( rf_flag == 0 )
        {
            ...
            case 1:
                ...
                Scale_sig(st_fx->shape3_filt_mem_fx, 10, (qGain-st_fx->qprevGain_fx));
                ...
                Scale_sig(st_fx->shape2_filt_mem_fx, 10, (qGain-st_fx->qprevGain_fx));

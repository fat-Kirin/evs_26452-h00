...
)
{
    ...
    *------------------------------------------------------------------*/
    ...
    test();
    test();
    IF( st_fx->Opt_SC_VBR_fx && vad_flag_fx == 0 && (EQ_16(st_fx->last_ppp_mode_fx,1)||EQ_16(st_fx->last_nelp_mode_fx,1)))
    {
        ...
        CNG_reset_enc_fx( st_fx, mem, pitch_buf_fx, voice_factors_fx, 1 );
    }
